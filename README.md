...
**本软件源码已放弃版权贡献到公共域** ，源码可使用 [aardio](http://www.aardio.com) 编译生成单文件绿色EXE，**点这里下载** （ [64位版本](./../../raw/master/release/winXray_x64.7z) / [32位版本](./../../raw/master/release/winXray_x86.7z) ），解压即可直接使用( 体积很小仅  **8 MB** - 已自带 V2Ray Core ）。  
